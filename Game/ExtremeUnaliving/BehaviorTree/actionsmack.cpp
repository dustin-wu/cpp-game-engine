#include "actionsmack.h"
#include "Engine/Components/rigidbodycomponent.h"
#include "Engine/Components/transformcomponent.h"

namespace ExtremeUnaliving {

ActionSmack::ActionSmack(std::shared_ptr<GameObject> entity, std::shared_ptr<GameObject> target, std::shared_ptr<HealthSystem> healthSystem,
...
Status ActionSmack::act(float deltaTime) {
    if (coolDown > 0) {
        coolDown -= deltaTime;
